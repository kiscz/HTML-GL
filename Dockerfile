...
##   $ docker build -t php-for-kiscz-html-gl .
##
## RUNNING
##   $ docker run -p 9000:9000 php-for-kiscz-html-gl
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="hvq8hnz" \
    STACKSMITH_STACK_NAME="PHP for kiscz/HTML-GL" \
